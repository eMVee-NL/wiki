...
Visit: [Pentestmonkey](http://pentestmonkey.net/)
...
Visit: [LOLBAS](https://lolbas-project.github.io/)

WADComs
---------
>WADComs is an interactive cheat sheet, containing a curated list of offensive security tools and their respective commands, to be used against Windows/AD environments.

Visit: [WADComs](https://wadcoms.github.io/)

Payload All The Things
---------
This is a super collection for pentesting on Github.

Visit: [Payload All The Things](https://github.com/swisskyrepo/PayloadsAllTheThings)

High on Coffee
---------
A great website about pentesting with a nice cheatsheet

Visit: [High on Coffee](https://highon.coffee/blog/reverse-shell-cheat-sheet/)

Hacktricks
---------
A great website with a lot of information about penetration testing.

Visit: [Hacktricks](https://book.hacktricks.xyz/)
