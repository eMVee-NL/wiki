# Wiki for during a pentest or CTF
...
Second change the the wiki.sh so it can be executed: `chmod +x wiki.sh`   
Then start the wiki `./wiki.sh`   



### Technology
This wiki is created with [mdwiki](http://dynalon.github.io/mdwiki/#!index.md). The wiki.sh file is running a python3 simple http server and opening the default browser so it is possible to navigate the wiki.
